...
<main class="l-fabrique">
    <h1 class="fabrique__title l-fabrique__title ff--nuxt">La fabrique à bière</h1>
    <div class="l-fabrique__form">
        <form method="post" class="initreceipt" id="form__initreceipt">
            <div class="initreceipt__group">
                <label for="receipt_name" class="initreceipt__label">Nom de la recette :</label>
                <input type="text" name="receipt_name" id="receipt_name" class="initreceipt__input" value="test">
            </div>
            <div class="initreceipt__group">
                <label for="receipt_volume" class="initreceipt__label">Volume :</label>
                <input type="number" name="receipt_volume" id="receipt_volume" min="1" class="initreceipt__input" value="33">
                <p class="initreceipt__suffix">litres</p>
            </div>
            <div class="initreceipt__group">
                <label for="receipt_boiling" class="initreceipt__label">Durée d'ébulition :</label>
                <input type="number" name="receipt_boiling" id="receipt_boiling" min="1" class="initreceipt__input" value="44">
            ...
            <div class="initreceipt__group">
                ...
                <input type="number" name="receipt_estimated_efficiency" id="receipt_estimated_efficiency" min="1" max="100" class="initreceipt__input" value="80">
    ...
    <div class="l-receipttabs l-fabrique__list">
        <ul class="tabreceipt" id="tab_receipt">
            ...
            <template id="template_ingredient_line">
                <li class="tabreceipt__line">
                    ...
                    <p class="tabreceipt__item remove ingredients__cross ingredients__cross--line"></p>
                </li>
            </template>
        </ul>
    </div>
    <div class="l-fabrique__side">
        <ul class="tabcarac">
            <li class="tabcarac__title ff--nuxt">
                <h3>Caractéristiques</h3>
            </li>
            <li class="tabcarac__item">
                <p class="tabcarac__subtitle">Total Malts :</p>
            ...
            <li class="tabcarac__item">
                <p class="tabcarac__subtitle">Total Houblons :</p>
                <p class="tabcarac__value">
            ...
            <li class="tabcarac__item">
                <p class="tabcarac__subtitle">Densité originelle (OG):</p>
                <p class="tabcarac__value">
                    <span class="tabcarac__content" id="originel-density">0</span>
                </p>
            </li>
            <li class="tabcarac__item">
                <p class="tabcarac__subtitle">Densité finale (FG):</p>
                <p class="tabcarac__value">
                    <span class="tabcarac__content" id="final-density">0</span>
                </p>
            </li>
            <li class="tabcarac__item">
                <p class="tabcarac__subtitle">Amertume (IBU):</p>
                <p class="tabcarac__value">
                    <span class="tabcarac__content" id="bitterness">0</span>
                </p>
            </li>
            <li class="tabcarac__item">
                <p class="tabcarac__subtitle">Couleur (EBC):</p>
                <p class="tabcarac__value">
                    <span class="tabcarac__content" id="color">0</span>
                </p>
            </li>
            <li class="tabcarac__item">
                <p class="tabcarac__subtitle">Alcool (ABV)</p>
                <p class="tabcarac__value">
        ...
        <div class="beer">
            <?php require_once('./assets/img/beer.svg') ?>
        </div>
    </div>
    <!-- MODAL INGREDIENTS -->
    <div class="modal-ingredients" id="modal-ingredients">
        <div class="modal-ingredients__inner">
            <div class="ingredients__cross" id="modal-cross"></div>
            <h2 class="modal-ingredients__title ff--nuxt">Ajouter un ingrédient</h2>
            <div class="modal-ingredients__leftcontent">
                <div class="tabs-ingredients">
                    <ul class="tabs-ingredients__list modal-tabs">
                        <li class="tabs-ingredients__item highlighted active" data-ingredient="malts">Malt</li>
                        <li class="tabs-ingredients__item highlighted" data-ingredient="houblons">Houblon</li>
                        <li class="tabs-ingredients__item highlighted" data-ingredient="levures">Levure</li>
                    </ul>
